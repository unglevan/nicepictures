...
class PhotographerController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Photographer');
	...
	{
		$model=new Photographer('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Photographer']))
			$model->attributes=$_GET['Photographer'];
	 ...
	 * @param Photographer $model the model to be validated
	 */
