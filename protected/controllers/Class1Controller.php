...
class Class1Controller extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Class1');
	...
	{
		$model=new Class1('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Class1']))
			$model->attributes=$_GET['Class1'];
	 ...
	 * @param Class1 $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='class1-form')
		{
