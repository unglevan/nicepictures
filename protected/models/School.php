...
class School extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idschool, idlocal, nameschool, address, phone, local', 'required'),
			array('idschool, idlocal', 'numerical', 'integerOnly'=>true),
			array('nameschool', 'length', 'max'=>33),
			array('address, local', 'length', 'max'=>100),
			array('phone', 'length', 'max'=>22),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idschool, idlocal, nameschool, address, phone, local', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'classes' => array(self::HAS_MANY, 'Class', 'idschool'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nameschool',$this->nameschool,true);
